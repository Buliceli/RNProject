        ...
        return(
            <Swiper style={styles.wrapper} showsButtons={false} autoplay = {true} autoplayTimeout = {1.5}>
                <View style={styles.slide1}>
                    <Image style={styles.text} source={require('../images/1.jpg')}/>
                </View>
                <View style={styles.slide2}>
                    {/*<Text style={styles.text}>Beautiful</Text>*/}
                    <Image style={styles.text} source={require('../images/2.jpg')}/>
                </View>
                <View style={styles.slide3}>
                    <Image style={styles.text} source={require('../images/3.jpg')}/>
                </View>
            </Swiper>
        );
    }
